...
var (
	...
	analysisTimeout   time.Duration = 60 * time.Minute
	kubeconfig        string        = ""
	configContext     string        = ""
)

type IstioPreCheck struct {
}

func Precheck(cli kube.ExtendedClient, namespace string, cmd *cobra.Command, kubecfg string, cfgContext string) (err error) {
